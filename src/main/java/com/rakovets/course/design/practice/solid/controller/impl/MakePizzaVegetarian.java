...
public final class MakePizzaVegetarian<T extends Ingredient> implements Command {
    ...
    public Pizza execute() {
        ...
        LinkedList<T> list = Stream.of(
                        ...
                        searchForIngredients.getIngredient("CHICKEN", collection, 150.00),
                        searchForIngredients.getIngredient("MAYONNAISE", collection, 130.00),
                        searchForIngredients.getIngredient("BEEF", collection, 150.00),
        ...
        return shopService.makePizzaVegetarian("Vegetarian", (Collection<Ingredient>) list);
    }
}
