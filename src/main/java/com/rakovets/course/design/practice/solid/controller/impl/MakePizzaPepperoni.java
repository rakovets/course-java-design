...
public final class MakePizzaPepperoni<T extends Ingredient> implements Command {
    ...
    public Pizza execute() {
        ...
        return shopService.makePizzaPepperoni("Pepperoni", (Collection<Ingredient>) list);
    }
}
